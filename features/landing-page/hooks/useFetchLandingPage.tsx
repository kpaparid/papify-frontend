import { checkDeviceTracks, getCollections, getDeviceTracks } from '@/api/callbacks';
import { useLoadData } from '@/hooks/useLoadData';
import { DataStateType, setCollections, setDeviceTracks } from '@/utils/redux/dataReducer';
...
export default function useFetchLandingPage() {
  ...
  const handleFetch = useCallback(async () => {
    ...
    return checkDeviceTracks(collectionData).then(data => dispatch(setDeviceTracks(data)));
  }, [collection]);
